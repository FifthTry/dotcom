...
impl SiteCommonData {
    pub fn new(
        ...
        SiteCommonData {
            ...
            info_url: ft_common::urls::site_info_url(site_slug),
            editor_url: ft_common::urls::site_editor_url(site_slug),
            github_url: ft_common::urls::github_url(site_slug),
            tokens_url: ft_common::urls::site_tokens_url(site_slug),
            domains_url: ft_common::urls::site_domains_url(site_slug),
            setting_url: ft_common::urls::site_domains_url(site_slug),
            cr_list_url: ft_common::urls::site_cr_list_url(site_slug),
